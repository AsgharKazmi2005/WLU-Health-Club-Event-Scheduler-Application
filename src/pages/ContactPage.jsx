    ...
    <>
      <Navbar />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-6 mt-12 rightsize">
          ...
          <Portrait image={Elizabeth} name="Elizabeth Sawicki" description="My name is Elizabeth Sawicki! I am in the class of 2029, majoring in Biology on a pre-veterinary track. I love being on the Women's Track and Field Team, I am a Hurdler and Triple Jumper." />
          <Portrait image={Shaylin} name="Shaylin Ainsworth" description="My name is Shaylin Ainsworth! I am a neuroscience major, class of 2028 and I enjoy playing the violin!" />
