    ...
    <>
      ...
      <div className="portraits">
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-6 mt-12 rightsize">
          ...
          <Portrait
            image={Daniel}
            name="Daniel Volodarsky"
            position="Founder and President"
            description="Hey my name is Daniel Volodarsky and I am the Captain and Founder of the AHA Heart Club here at Washington and Lee University. I am a sophomore Biology and Music major on the pre-med track and am also proud to be an AHA licensed CPR Instructor. I love to talk to my friends, play violin, and study botany in my free time!"
          />
          ...
          <Portrait
            image={Bariz}
            name="Bariz Sultankhil"
            position="Assistant Treasurer"
            description="Hi, I'm Bariz Sultankhil! I live in Denver, Colorado, and I'm a neuroscience major on the pre-med track. I have a strong passion for research and healthcare. Outside of academics, I enjoy hiking, playing soccer, drawing, and learning new languages. I'm always excited to connect with others who share similar interests!"
          />

          <Portrait
            image={Gabe}
            name="Gabe Castillo"
            position="CPR Instruction Chair"
            description="My name is Gabe Castillo and I’m the CPR Instruction Chair of the AHA Heart Club here at Washington and Lee University. I’m a first-year studying Biology on the pre-med track. I’m passionate about global health equity and serving others through healthcare. I love exploring music, weightlifting, and playing piano."
          />
          ...
          {/* <Portrait
            ...
            description="Hi! I’m Clara Avery, the Social Chair of the AHA Heart Club. I’m passionate about connecting people and building community through our events and outreach."
          /> */}

          <Portrait
            image={Shaylin}
            name="Shaylin Ainsworth"
            position="Secretary"
            description="My name is Shaylin Ainsworth! I am a neuroscience major, class of 2028 and I enjoy playing the violin!"
          />
      ...
      <div className="calendar-main flex flex-col items-center min-h-screen bg-[#402121]/95 text-white">
        <div className="contact-form w-[60%] bg-[#1a1a1a] shadow-lg rounded-lg p-8 mt-10 hover:shadow-xl hover:scale-[1.02] border border-transparent hover:border-[rgba(255,145,145,0.95)] transition-all duration-700">
          <h2 className="text-3xl font-bold text-center mb-6 text-[rgba(255,145,145,0.95)]">
            Contact Us
          </h2>
          <form
            action="https://formsubmit.co/7da7c43e1f234e2e51c7abad9ea8c367"
            method="POST"
            className="space-y-4"
          >
            ...
            <input
              ...
              name="name"
              required
              className="w-full p-2 border border-[#333] rounded-lg bg-[#121212] text-white focus:ring-2 focus:ring-[rgba(255,145,145,0.95)]"
            />
            ...
            <textarea
              name="message"
              required
              className="w-full p-2 border border-[#333] rounded-lg bg-[#121212] text-white h-32 focus:ring-2 focus:ring-[rgba(255,145,145,0.95)]"
            ></textarea>

            <button
              type="submit"
              className="w-full bg-[rgba(255,145,145,0.95)] text-white py-2 rounded-lg hover:bg-[rgba(255,145,145,1)] transition"
            >
              Send
            </button>
          </form>
